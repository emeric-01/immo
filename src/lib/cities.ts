...
export const southCities: City[] = [
  ...
  },
  {
    ...
    latitude: 43.1882,
    longitude: 5.6175,
    nearbySlugs: ["ceyreste", "cassis", "saint-cyr-sur-mer", "cuges-les-pins"],
  },
  {
    slug: "allauch",
    name: "Allauch",
    ...
    latitude: 43.3522,
    longitude: 5.5103,
    nearbySlugs: ["plan-de-cuques", "marseille-12e", "marseille-11e", "marseille"],
  },
  {
    slug: "gardanne",
    name: "Gardanne",
    ...
    latitude: 43.4585,
    longitude: 5.4857,
    nearbySlugs: ["bouc-bel-air", "mimet", "simiane-collongue", "aix-en-provence"],
  },
  {
    slug: "bouc-bel-air",
    name: "Bouc-Bel-Air",
    ...
    latitude: 43.4442,
    longitude: 5.4118,
    nearbySlugs: ["gardanne", "simiane-collongue", "aix-en-provence", "marseille"],
  },
  {
    slug: "roquevaire",
    name: "Roquevaire",
    ...
    latitude: 43.3452,
    longitude: 5.598,
    nearbySlugs: ["aubagne", "auriol", "la-destrousse", "peypin"],
  },
  {
    slug: "la-destrousse",
    name: "La Destrousse",
    ...
    latitude: 43.3788,
    longitude: 5.5984,
    nearbySlugs: ["roquevaire", "peypin", "la-bouilladisse", "auriol"],
  },
  {
    slug: "cadolive",
    name: "Cadolive",
    ...
    latitude: 43.3943,
    longitude: 5.5303,
    nearbySlugs: ["saint-savournin", "peypin", "belcodene", "mimet"],
  },
  {
    ...
    latitude: 43.4025,
    longitude: 5.5321,
    nearbySlugs: ["cadolive", "mimet", "belcodene", "allauch"],
  },
  {
    slug: "belcodene",
    name: "Belcodène",
    ...
    latitude: 43.4231,
    longitude: 5.5846,
    nearbySlugs: ["la-bouilladisse", "peypin", "cadolive", "auriol"],
  },
  {
    slug: "mimet",
    name: "Mimet",
    ...
    latitude: 43.4123,
    longitude: 5.5001,
    nearbySlugs: ["gardanne", "simiane-collongue", "saint-savournin", "cadolive"],
  },
  {
    ...
    latitude: 43.4154,
    longitude: 5.4359,
    nearbySlugs: ["mimet", "gardanne", "bouc-bel-air", "marseille"],
  },
  {
    ...
    latitude: 43.3942,
    longitude: 5.626,
    nearbySlugs: ["la-destrousse", "peypin", "belcodene", "auriol"],
  },
  {
    slug: "peypin",
    name: "Peypin",
    ...
    latitude: 43.3834,
    longitude: 5.57,
    nearbySlugs: ["la-destrousse", "cadolive", "la-bouilladisse", "roquevaire"],
  },
  {
    slug: "plan-de-cuques",
    name: "Plan-de-Cuques",
    ...
    latitude: 43.3642,
    longitude: 5.4639,
    nearbySlugs: ["allauch", "marseille", "marseille-12e", "marseille-11e"],
  },
  {
    slug: "marseille-11e",
    name: "Marseille 11e",
    ...
    latitude: 43.2877,
    longitude: 5.4787,
    nearbySlugs: ["marseille-12e", "aubagne", "la-penne-sur-huveaune", "allauch"],
  },
  {
    slug: "marseille-12e",
    name: "Marseille 12e",
    ...
    latitude: 43.3071,
    longitude: 5.4418,
    nearbySlugs: ["marseille-11e", "allauch", "plan-de-cuques", "marseille"],
  },
  {
    slug: "toulon",
    name: "Toulon",
