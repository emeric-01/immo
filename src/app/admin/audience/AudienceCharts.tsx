...
export function AudienceCharts({ summary }: { summary: SiteAnalyticsSummary }) {
  ...
  return <section className={styles.charts}>
    <article className={styles.chartCard}><header><span>Tendance</span><h2>Trafic quotidien</h2></header><div className={styles.mainChart}><ResponsiveContainer height="100%" width="100%"><AreaChart data={summary.daily} margin={{ left: 0, right: 0, top: 12 }}><defs><linearGradient id="humanFill" x1="0" x2="0" y1="0" y2="1"><stop offset="0" stopColor="#b77547" stopOpacity=".3"/><stop offset="1" stopColor="#b77547" stopOpacity="0"/></linearGradient></defs><CartesianGrid stroke="#eee5dc" strokeDasharray="4 4" vertical={false}/><XAxis axisLine={false} dataKey="date" fontSize={11} interval="preserveStartEnd" tickLine={false}/><YAxis allowDecimals={false} axisLine={false} fontSize={11} tick={{ fill: "#b77547" }} tickLine={false} width={36} yAxisId="human"/><YAxis allowDecimals={false} axisLine={false} fontSize={11} orientation="right" tick={{ fill: "#171512" }} tickLine={false} width={42} yAxisId="robot"/><Tooltip contentStyle={{ border: "1px solid #e3d8ce", borderRadius: 8 }}/><Area dataKey="humains" fill="url(#humanFill)" name="Humains" stroke="#b77547" strokeWidth={2.5} yAxisId="human"/><Area dataKey="robots" fill="transparent" name="Robots" stroke="#171512" strokeDasharray="5 4" strokeWidth={1.8} yAxisId="robot"/><Area dataKey="incertains" fill="transparent" name="Incertain" stroke="#aaa097" strokeWidth={1.5} yAxisId="human"/></AreaChart></ResponsiveContainer></div></article>
