    ...
    <footer className={styles.footer}>
      <div className={styles.footerTop}>
        ...
        <div className={styles.footerColumns} id="a-propos">
          ...
          <nav aria-label="L'agence"><strong>L’agence</strong><Link href="/qui-sommes-nous">Qui sommes-nous</Link><Link href="/recherche">Nous confier un projet</Link><Link href="/estimation">Nous contacter</Link></nav>
        </div>
      </div>
